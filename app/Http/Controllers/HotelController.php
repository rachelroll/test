            ...
            foreach($searchLists as $searchList) {
                ...
                if (!empty($hotel_info['roomList'])) {
                    $hotel_id = DB::table('sline_hotel')->insertGetId([
                        ...
                        'traffic' => isset($hotel_info['extInfo']['traffic']) ?: '',
                        'notice' => isset($hotel_info['extInfo']['policy']) ?: '',
                        'decoration_time' => isset($hotel_info['createTime']) ?: '',
                        'webid' => 0,
                        'satisfyscore' => 100,
                    ...
                    foreach ($hotel_info['roomList'] as $v) {
                        ...
                        if ($roomtype) {
                            ...
                            $suitid = DB::table('sline_hotel_room')->insertGetId([
                                ...
                                'breakfirst' => $roomtype[$v['roomtypeId']][0]['breakfast'],
                                'pay_way' => 2, // 支付方式：线下
                            ]);
